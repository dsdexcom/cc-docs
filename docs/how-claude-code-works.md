...
[Image: The agentic loop: Your prompt leads to Claude gathering context, taking action, verifying results, and repeating until task complete. You can interrupt at any point.]
...
[Image: Session continuity: resume continues the same session, fork creates a new branch with a new ID.]
